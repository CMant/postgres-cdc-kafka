...
// kafka字符串类参数
// --- 字符串类型参数 ---
extern PGDLLIMPORT char *kafka_server;
extern PGDLLIMPORT char *kafka_security_protocol;
extern PGDLLIMPORT char *kafka_ssl_cipher_suites;
extern PGDLLIMPORT char *kafka_ssl_key_location;
extern PGDLLIMPORT char *kafka_ssl_key_password;
extern PGDLLIMPORT char *kafka_ssl_certificate_location;
extern PGDLLIMPORT char *kafka_ssl_ca_location;
extern PGDLLIMPORT char *kafka_ssl_endpoint_identification_algorithm;
extern PGDLLIMPORT char *kafka_sasl_mechanism;
extern PGDLLIMPORT char *kafka_sasl_username;
extern PGDLLIMPORT char *kafka_sasl_password;
extern PGDLLIMPORT char *kafka_compression_codec;
extern PGDLLIMPORT char *kafka_client_id;
extern PGDLLIMPORT char *kafka_debug;

// --- 整型参数 ---
extern PGDLLIMPORT int kafka_queue_buffering_max_messages;
extern PGDLLIMPORT int kafka_queue_buffering_max_kbytes;
extern PGDLLIMPORT int kafka_queue_enqueue_timeout_ms;
extern PGDLLIMPORT int kafka_batch_num_messages;
extern PGDLLIMPORT int kafka_retries;
extern PGDLLIMPORT int kafka_retry_backoff_ms;
extern PGDLLIMPORT int kafka_message_timeout_ms;
extern PGDLLIMPORT int kafka_socket_send_buffer_bytes;
extern PGDLLIMPORT int kafka_socket_receive_buffer_bytes;
extern PGDLLIMPORT int kafka_socket_connection_setup_timeout_ms;
extern PGDLLIMPORT int kafka_metadata_max_age_ms;
extern PGDLLIMPORT int kafka_compression_level;
extern PGDLLIMPORT int kafka_log_level;

// --- 布尔类型参数 ---
extern PGDLLIMPORT bool kafka_enable_ssl_certificate_verification;
extern PGDLLIMPORT bool kafka_enable_idempotence;
extern PGDLLIMPORT bool kafka_enable_gapless_guarantee;
extern PGDLLIMPORT bool kafka_log_connection_close;
// 后面是系统自带参数
